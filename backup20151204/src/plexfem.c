...
DMPlexAddBoundary(dm, PETSC_TRUE, "inflow",  "Face Sets", 0, (void
(*)()) PhysicsBoundary_Advect_Inflow,  ALEN(inflowids),  inflowids,  phys)

it says

    PETSC_TRUE:   This is an essential boundary condition
    "inflow":     The boundary is named "inflow" so I can use
                  -bc_inflow 100,101,200
    "Face Sets":  The name of the Plex label describing the boundary
    PhysicsBoundary_Advect_Inflow: The function implementing the BC
    ALEN(inflowids): The number of label ids which are constrained
    inflowids: The label ids which give the constrained point
(face) sets
    phys:      The user context
