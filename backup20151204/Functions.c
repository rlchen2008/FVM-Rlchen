...
PetscScalar SourceRho(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord)
{
  PetscScalar       result;
...
@*/
PetscScalar SourceU(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord)
{
  PetscScalar       gradu[DIM][DIM];
  PetscScalar       gradRhoU[DIM][DIM];
  PetscScalar       gradRho[DIM];
  PetscScalar       gradRhoE[DIM];
  PetscInt        i, j;
  PetscScalar       f, result;
...
@*/
PetscScalar SourceV(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord)
{
PetscScalar       gradu[DIM][DIM];
  PetscScalar       gradRhoU[DIM][DIM];
  PetscScalar       gradRho[DIM];
...
@*/
PetscScalar SourceW(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord)
{
  PetscScalar       gradu[DIM][DIM];
  PetscScalar       gradRhoU[DIM][DIM];
  PetscScalar       gradRho[DIM];
...
@*/
PetscScalar SourceE(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord)
{
  PetscScalar       gradu[DIM][DIM];
  PetscScalar       gradRho[DIM];
  PetscScalar       gradT[DIM];
  PetscInt        i, j;
  PetscScalar       f, phi, other, result;
  const Node      *X = (const Node*)x;
  PetscScalar       yy;
  PetscScalar     U, H, uu;
