...
extern PetscErrorCode RiemannSolver(User user, const PetscScalar *cgradL, const PetscScalar *cgradR,
...
extern PetscScalar SourceRho(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord);
extern PetscScalar SourceU(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord);
extern PetscScalar SourceV(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord);
extern PetscScalar SourceW(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord);
extern PetscScalar SourceE(User user, const PetscScalar *cgrad, const PetscScalar *x, const PetscScalar *xcoord);
